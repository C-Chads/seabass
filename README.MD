...
Seabass is advancing rapidly. If the blessings of God continue, the project
should reach a "completed" state fairly soon
...
Seabass must have:
 ...
 [ ] A large set of domain specific languages
