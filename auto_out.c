...
static inline TGT_IMAX __CBAS__SEEK_SET(){
    return SEEK_SET;
}
static inline TGT_IMAX __CBAS__SEEK_CUR(){
    return SEEK_CUR;
}
static inline TGT_IMAX __CBAS__SEEK_END(){
    return SEEK_END;
}
...
static inline unsigned long long __CBAS__utf8_strlen(unsigned char* __cbas_local_variable_mangled_name_s)
{
    ...
    (__cbas_local_variable_mangled_name_l) = (0ull);
    while((long long)(((unsigned char*)(__cbas_local_variable_mangled_name_s))[(long long)(0ull)])){

    if(((((unsigned long long)(((unsigned char*)(__cbas_local_variable_mangled_name_s))[(long long)(0ull)])) >> (6ull)) & (3ull)) != (2ull)){

    (__cbas_local_variable_mangled_name_l)++;
    }

    }

    
    return (unsigned long long)(__cbas_local_variable_mangled_name_l);
...
static inline long long __CBAS__utf8_isascii(unsigned char* __cbas_local_variable_mangled_name_s)
{
    ...
    if((long long)((((unsigned long long)(((unsigned char*)(__cbas_local_variable_mangled_name_s))[(long long)(0ull)])) >> (7ull)) & (1ull))){
...
static inline long long __CBAS__utf8_getchar(unsigned char* __cbas_local_variable_mangled_name_dest,unsigned char* __cbas_local_variable_mangled_name_src,unsigned char** __cbas_local_variable_mangled_name_endptr,long long* __cbas_local_variable_mangled_name_lenout)
{
    ...
    (__cbas_local_variable_mangled_name_len) = ((long long)(0ull));
    if(((((unsigned long long)(((unsigned char*)(__cbas_local_variable_mangled_name_src))[(long long)(0ull)])) >> (7ull)) & (1ull)) == (0ull)){

    (__cbas_local_variable_mangled_name_len) = ((long long)(1ull));
    (((unsigned char*)(__cbas_local_variable_mangled_name_dest))[(long long)(0ull)]) = ((unsigned char)(((unsigned char*)(__cbas_local_variable_mangled_name_src))[(long long)(0ull)]));
    (__cbas_local_variable_mangled_name_dest)++;
    (__cbas_local_variable_mangled_name_src)++;
    goto __cbas_mangled_label__setendptr;
    }

    if(((((unsigned long long)(((unsigned char*)(__cbas_local_variable_mangled_name_src))[(long long)(0ull)])) >> (6ull)) & (3ull)) == (2ull)){

    goto __cbas_mangled_label__onerr;
    }

    (__cbas_local_variable_mangled_name_nb) = ((long long)(2ull));
    if((long long)((((unsigned long long)(((unsigned char*)(__cbas_local_variable_mangled_name_src))[(long long)(0ull)])) >> (5ull)) & (1ull))){

    (__cbas_local_variable_mangled_name_nb)++;
    }
    ...
    if((long long)((((unsigned long long)(((unsigned char*)(__cbas_local_variable_mangled_name_src))[(long long)(0ull)])) >> (4ull)) & (1ull))){
    ...
    if(((unsigned char**)(__cbas_local_variable_mangled_name_endptr)) != ((unsigned char**)(0ull))){

    (((unsigned char**)(__cbas_local_variable_mangled_name_endptr))[(long long)(0ull)]) = ((unsigned char*)(__cbas_local_variable_mangled_name_src));
    }

    if(((long long*)(__cbas_local_variable_mangled_name_lenout)) != ((long long*)(0ull))){

    (((long long*)(__cbas_local_variable_mangled_name_lenout))[(long long)(0ull)]) = ((long long)(__cbas_local_variable_mangled_name_len));
    }
