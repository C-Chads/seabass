...
"\tcgscope* myscope\n"
"\tu64 kind\n"
"\tu8*[CG_STMT_MAX_EXPRESSIONS] expressions\n"
"\tu64 nexpressions\n"
...
"end\n"
"\n"
"#define cg_getast __builtin_get_ast\n"
"\n"
...
"\t\n"
"\t//pop walker's right.\n"
"\tif(cast(uptr)walker.right.text)\n"
...
"\tu64 len;\n"
"\tlen = 1; //include 1 token already...\n"
"\ti64 level;\n"
"\tlevel = 1;\n"
"\tfor(walker = p.right, walker != cast(cgstrll*)0, walker = walker.right)\n"
"\t\tlen++; //not at the end, because we start with p.right.\n"
"\t\tif(walker.d == CG_TOK_OBRACK) level++; \n"
"\t\telif(walker.d == CG_TOK_CBRACK) level--; end\n"
"\t\tif(level == 0) break; end\n"
"\tend\n"
"\tif(level != 0)\n"
